...
const setError = (state: IAuthState, action: PayloadAction<string | undefined>) => {
  state.loading = false
...
const authSlice = createSlice({
  ...
  extraReducers: (build) => {
    ...
    build.addCase(login.fulfilled, (state: IAuthState, action: PayloadAction<IAuth>) => {
      state.loading = false
      state.error = undefined
    ...
    build.addCase(loginByFb.fulfilled, (state: IAuthState, action: PayloadAction<IAuth>) => {
      state.loading = false
      state.currentUser = action.payload
      state.error = undefined
    })
