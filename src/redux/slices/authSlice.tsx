...
const setError = (state: IStateAuth, action: PayloadAction<string | undefined>) => {
  state.loading = false
...
const authSlice = createSlice({
  ...
  extraReducers: (build) => {
    ...
    build.addCase(login.fulfilled, (state: IStateAuth, action: PayloadAction<IAuth>) => {
      state.loading = false
      state.error = undefined
    ...
    build.addCase(register.fulfilled, (state: IStateAuth) => {
      state.loading = false
      state.error = undefined
    })
    ...
    build.addCase(forgotPassword.fulfilled, (state: IStateAuth) => {
      state.loading = false
      state.error = undefined
    })
    ...
    build.addCase(changePassword.fulfilled, (state: IStateAuth) => {
      state.loading = false
      state.error = undefined
    })
    build.addCase(changePassword.rejected, setError)

    build.addCase(loginByFb.fulfilled, (state: IStateAuth, action: PayloadAction<IAuth>) => {
      state.loading = false
      state.currentUser = action.payload
      state.error = undefined
    })
