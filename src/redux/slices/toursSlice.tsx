...
const setError = (state: ITourState, action: PayloadAction<string | undefined>) => {
  state.loading = false
...
const toursSlice = createSlice({
  ...
  extraReducers: (build) => {
    ...
    build.addCase(getAllTour.fulfilled, (state: ITourState, action: PayloadAction<ITour[]>) => {
      state.loading = false
      state.error = false
    ...
    build.addCase(getTourById.fulfilled, (state: ITourState, action: PayloadAction<ITour>) => {
      state.loading = false
      state.error = false
    ...
    build.addCase(changeFavoriteTour.fulfilled, (state: ITourState, action: PayloadAction<ITour>) => {
      state.loading = false
      state.error = false
...
export const { filterByDuration, filterByLocation, filterByGuest, filterByPrice, filterByType } = toursSlice.actions
