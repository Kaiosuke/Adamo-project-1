    ...
    <section className="main-container pt-6 text-four">
      ...
      <div className="max-w-[880px] w-full">
        <div className="italic mt-4">
          <p>
            Ojimah.com (hereinafter, “United GB Sarl” or “We”) values its users
            and it is committed to protect your privacy. In order to fulfill
            this commitment, Ojimah has developed this privacy policy
            (hereinafter, the “Privacy Policy” or “Policy”) outlining Ojimah’s
            practices regarding the collection, use, preservation and disclosure
            of personal information collected in accordance with applicable
            laws.
          </p>
          <br />
          <p>
            When You use Ojimah’s services, whether to make searches, sign in to
            receive offers and news, or purchase any service through any other
            of its sale channels, call center, website (hereinafter, the
            “Website”) or application for mobiles and tablets (hereinafter, the
            “Application”) you trust information to us. This Privacy Policy
            seeks to help you understand which data we collect, why we do it,
            and what we do with such data. You, as a user, accept the practices
            detailed below, so we recommend you to carefully read the
