...
const InputAuth = ({ form, title, name, type = "text" }: IInputAuth) => {
        ...
        <FormItem>
          <FormControl className="relative">
            <div className="">
              ...
              <FormLabel
                htmlFor={name}
                className="absolute left-0 top-1/2 -translate-y-1/2 text-base text-four transition-all peer-focus:top-0"
              >
                {title}
              </FormLabel>
